...
{
    public class MealsSnacksUnhealthySnackPageVmProvider : PageVmProviderBase, IMealsSnacksUnhealthySnackPageVmProvider
    {
        private readonly IUserDataService _userDataService;
        private readonly IFastingDataService _fastingDataService;

        public MealsSnacksUnhealthySnackPageVmProvider(ITokenService tokenService, IUserDataService userDataService, IFastingDataService fastingDataService) :
            base(tokenService)
        {
        ...
        public async Task<ApiCallResult<MealDataProxy>> AddUnhealthySnackAsync(MealDataProxy proxy, CancellationToken cancellationToken)
        {
