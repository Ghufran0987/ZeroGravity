...
{
    public class MealsSnacksDinnerPageVmProvider : PageVmProviderBase, IMealsSnacksDinnerPageVmProvider
    {
        private readonly IUserDataService _userDataService;
        private readonly IFastingDataService _fastingDataService;

        public MealsSnacksDinnerPageVmProvider(ITokenService tokenService, IUserDataService userDataService, IFastingDataService fastingDataService) : base(
            tokenService)
        {
        ...
        public async Task<ApiCallResult<MealDataProxy>> AddDinnerAsync(MealDataProxy proxy, CancellationToken cancellationToken)
        {
        ...
        public async Task<ApiCallResult<MealDataProxy>> UpdateDinnerAsync(MealDataProxy proxy, CancellationToken cancellationToken)
        {
            var dto = ProxyConverter.GetMealDataDto(proxy);
