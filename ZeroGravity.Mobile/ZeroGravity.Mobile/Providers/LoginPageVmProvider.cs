...
{
    public class LoginPageVmProvider : PageVmProviderBase, ILoginPageVmProvider
    {
        ...
        public LoginPageVmProvider(ISecureStorageService secureStorageService, ILoggerFactory loggerFactory,
            ITokenService tokenService, ILoginService loginService, IUserDataService userDataService): base(tokenService)
        {
            ...
            _logger = loggerFactory?.CreateLogger<LoginPageVmProvider>() ?? new NullLogger<LoginPageVmProvider>();
        }
