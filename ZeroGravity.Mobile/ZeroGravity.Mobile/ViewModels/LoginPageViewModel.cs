...
{
    public class LoginPageViewModel : VmBase<ILoginPage, ILoginPageVmProvider, LoginPageViewModel>
    {
        private LoginProxy _proxy;
        private CancellationTokenSource _cts;

        public LoginPageViewModel(IVmCommonService service, ILoginPageVmProvider provider, ILoggerFactory loggerFactory,
            IApiService apiService) : base(service, provider, loggerFactory, apiService)
        ...
        private async void LoginExecute()
        {
            ...
            ContentShellPageViewModel.IsSessionTimeoutShown = false;
            IsBusy = false;
        }
