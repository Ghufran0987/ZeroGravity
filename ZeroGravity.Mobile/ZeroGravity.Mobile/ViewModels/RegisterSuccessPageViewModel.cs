...
{
    public class RegisterSuccessPageViewModel : VmBase<IRegisterSuccessPage, IRegisterSuccessPageVmProvider, RegisterSuccessPageViewModel>
    {
        public RegisterSuccessPageViewModel(IVmCommonService service, IRegisterSuccessPageVmProvider provider, ILoggerFactory loggerFactory, bool checkInternet = true) : base(service, provider, loggerFactory, checkInternet)
        {
