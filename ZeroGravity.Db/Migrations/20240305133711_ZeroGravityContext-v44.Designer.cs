...
namespace ZeroGravity.Db.Migrations
{
    ...
    [Migration("20240305133711_ZeroGravityContext-v44")]
    partial class ZeroGravityContextv44
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ZeroGravity.Db.Models.GlucoseTrend", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("AssociatedActivityDataId")
                        .HasColumnType("int");

                    b.Property<int?>("AssociatedMealDataId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AssociatedActivityDataId");

                    b.HasIndex("AssociatedMealDataId");

                    b.HasIndex("SessionId");

                    b.HasIndex("AccountId", "SessionId");

                    b.ToTable("GlucoseTrend");
                });

            modelBuilder.Entity("ZeroGravity.Db.Models.InsightReportVideo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ZeroGravity.Db.Models.SugarBeatData.SugarBeatGlucoseData", b =>
                {
                    ...
                    b.HasIndex("AccountId", "Created", "TransmitterId")
                        .IsUnique();
            ...
            modelBuilder.Entity("ZeroGravity.Db.Models.Users.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 5, 13, 37, 10, 941, DateTimeKind.Local).AddTicks(9330),
                            ...
                            Role = 0,
                            UnitDisplayType = 0,
                            Verified = new DateTime(2024, 3, 5, 13, 37, 10, 941, DateTimeKind.Local).AddTicks(9360),
                        ...
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 5, 13, 37, 10, 941, DateTimeKind.Local).AddTicks(9440),
                            ...
                            Role = 1,
                            UnitDisplayType = 1,
                            Verified = new DateTime(2024, 3, 5, 13, 37, 10, 941, DateTimeKind.Local).AddTicks(9440),
                            WantsNewsletter = false
                        },
                        new
                        {
                            ...
                            AcceptTerms = true,
                            CompletedFirstUseWizard = true,
                            Created = new DateTime(2024, 3, 5, 13, 37, 10, 941, DateTimeKind.Local).AddTicks(9450),
                            DateTimeDisplayType = 1,
                            ...
                            Role = 1,
                            UnitDisplayType = 1,
                            Verified = new DateTime(2024, 3, 5, 13, 37, 10, 941, DateTimeKind.Local).AddTicks(9460),
                            WantsNewsletter = false
                        });
                });
            ...
            modelBuilder.Entity("ZeroGravity.Db.Models.Users.AppInfoData", b =>
                {
                    ...
                    b.HasIndex("AccountId", "Platform", "Model", "OSVersion", "AppVersion")
                        .IsUnique()
                        .HasFilter("[Platform] IS NOT NULL AND [Model] IS NOT NULL AND [OSVersion] IS NOT NULL AND [AppVersion] IS NOT NULL");

                    b.ToTable("AppInfoData");
                });

            modelBuilder.Entity("ZeroGravity.Db.Models.Users.ConfirmedSensorPurchaseUserData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("OnboardingAccessDateTime")
                        .HasColumnType("datetime2");

                    b.Property<string>("OnboardingAccessToken")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("ConfirmedSensorPurchaseUserData");
                });
            ...
            modelBuilder.Entity("ZeroGravity.Db.Models.GlucoseTrend", b =>
                {
                    b.HasOne("ZeroGravity.Db.Models.ActivityData", "AssociatedActivityData")
                        .WithMany()
                        .HasForeignKey("AssociatedActivityDataId");

                    b.HasOne("ZeroGravity.Db.Models.MealData", "AssociatedMealData")
                        .WithMany()
                        .HasForeignKey("AssociatedMealDataId");
                    ...
                    b.Navigation("AssociatedActivityData");

                    b.Navigation("AssociatedMealData");
