...
{
    public class GetGlucoseDatasByAccountIdAndDateForManual : IDbQuery<List<Models.GlucoseData>, ZeroGravityContext>
    {
        private readonly int _accountId;
        private readonly DateTime _clientsBeginOfDayDateTimeInUtc;

        public GetGlucoseDatasByAccountIdAndDateForManual(int accountId, DateTime dateTime)
        {
