...
{
    public class GetMealFromDatespan : IDbQuery<List<MealData>, ZeroGravityContext>
    {
        private readonly long _accountId;
        private readonly DateTime _initialDateTime;
        private readonly DateTime _targetDateTime;

        public GetMealFromDatespan(long accountId, DateTime initialDateTime, DateTime targetDateTime)
        {
        ...
        {
            return await dbContext.MealDatas.Where(_ =>
